...
const locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: '©2016 –2018 Qorai Software. Qorai is a registered trademark of Qorai Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote: 'To protect your privacy, this Qorai Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from Qorai in the event of data loss on your device.',
  addFunds: 'add funds',
  addFundsFAQ: 'the FAQ',
  addFundsNote: 'Reminder: The Qorai Wallet is unidirectional and BAT flows to creators sites. For more information about Qorai Rewards, please visit',
  addFundsQR: 'Show QR Code',
  addFundsText: 'Be sure to use the address below that matches the type of cryto you own. It will be converted automatically to BAT by Uphold and appear as an increased balance in your Qorai Rewards wallet. Please allow up to one hour for your wallet balance to update.',
  addFundsTitle: 'Send cryptocurrency from your external account to your Qorai Rewards wallet.',
  ads: 'Ads',
  ...
  bat: 'BAT',
  qoraiAdsDesc: 'No action required. Just collect tokens. Your data is safe with our Shields.',
  qoraiAdsTitle: 'Qorai Ads',
  qoraiAdsLaunchTitle: 'Qorai Ads has arrived!',
  qoraiContributeDesc: 'Set budget and browse normally. Your favorite sites get paid automatically.',
  qoraiContributeTitle: 'Auto-Contribute',
  qoraiRewards: 'Qorai Rewards',
  qoraiRewardsDesc: 'Earn tokens for viewing privacy-respecting ads, and pay it forward by supporting content creators you love!',
  qoraiRewardsOptInText: 'Yes, I\'m In!',
  qoraiRewardsSubTitle: 'Get Rewarded for Browsing!',
  qoraiRewardsTeaser: 'How it works...',
  qoraiRewardsTitle: 'Qorai Rewards',
  qoraiVerified: 'Verified Creators',
  cancel: 'Cancel',
  ...
  connectedText: 'This creator has not yet signed up to receive contributions from Qorai users. Any tips you send will remain in your wallet until they verify.',
  ...
  qoraiRewardsCreatingText: 'Creating wallet',
  date: 'Date',
  deposit: 'Deposit',
  deposits: 'Deposits',
  ...
  disabledPanelPrivateText: 'Qorai Rewards is not available while in a Private Window.',
  ...
  disabledPanelTitle: 'Qorai Rewards is',
  dismiss: 'Closed',
  ...
  enableRewards: 'Enable Qorai Rewards',
  ...
  for: 'for',
  grants: 'Grants',
  grantDisclaimer: 'Unused tokens by the expiration date will be automatically returned to the Qorai User Growth Pool.',
  ...
  noAdsHistory: 'There is currently no Qorai Ads history',
  ...
  rewardsBannerText1: 'Thanks for stopping by. We joined Qorai’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsOffText2: 'Qorai Rewards allows you to take control back.',
  rewardsOffText3: 'Today, Qorai welcomes you to the new internet.',
  ...
  rewardsPanelEmptyText4: 'You can earn tokens from Qorai Ads.',
  rewardsPanelEmptyText5: 'Occasionally, you\'ll be offered free token grants from Qorai. Be sure to keep an eye out for the alert!',
  ...
  rewardsPanelText2: 'Your Qorai wallet is powered by',
  rewardsPanelText3: 'Qorai Rewards is built on the Basic Attention Token. Learn more about BAT',
  ...
  sendTip: 'Send my Tip',
  serviceText: 'By clicking \'Enable Qorai Rewards\', you indicate that you have read and agree to the',
  serviceTextToggle: 'By turning on Qorai Rewards, you indicate that you have read and agree to the',
  ...
  siteBannerNoticeText: 'This Creator has not yet verified their site. As soon as they verify with Qorai, they will receive your tip.',
  siteBannerConnectedText: 'This creator has not yet signed up to receive contributions from Qorai users. Your browser will keep trying to contribute until they verify, or until 90 days have passed.',
  sites: 'sites',
  ...
  turnOnRewardsDesc: 'This enables both Qorai Ads and Auto-Contribute. You can always opt out each any time.',
  ...
  unVerifiedText: 'This creator has not yet signed up to receive contributions from Qorai users.',
  ...
  walletDisconnect: 'Disconnect from Qorai Rewards',
  ...
  walletVerificationList3: 'Withdraw BAT that you may have previously added to your Qorai Rewards wallet',
  ...
  walletVerificationNote2: 'Qorai Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.',
  ...
  welcomeDescOne: 'You can now earn tokens for watching privacy focused Qorai Ads. Your contribution stays the same.',
  ...
  welcomeHeaderOne: 'Qorai Payments is now Qorai Rewards with many upgrades.',
  welcomeHeaderTwo: 'You are about to start a very Qorai way to browse the web.',
  whyQoraiRewards: 'Why Qorai Rewards?',
  whyQoraiRewardsDesc1: 'With conventional browsers, you pay to browse the web by viewing ads with your valuable attention, spending your valuable time downloading invasive ad technology, that transmits your valuable private data to advertisers — without your consent.',
  whyQoraiRewardsDesc2: 'Well, you\'ve come to the right place. Qorai welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyHow: 'Why & How',
